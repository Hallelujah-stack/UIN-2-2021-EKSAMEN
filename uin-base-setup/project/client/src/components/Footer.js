...
<StyledDiv>
    ...
    <StyledDiv2>
        ...
        <p>VG har ikke ansvar for innhold på eksterne nettsider<br />som det lenkes til. Kopiering av materiale fra VG for<br /> bruk annet sted er ikke tillatt uten avtale.</p>
    </StyledDiv2>
</StyledDiv>
);
